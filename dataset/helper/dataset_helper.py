...
dom_path = "/data/nrw_data/domnrw/"  # Path to the ndsm data. The subfolder of domnrw then contains all .tif files of the ndsm
...
sen_example = "/data/nrw_data/sennrw/S2_L3A_WASP/files/32/U/LB/2020/SENTINEL2X_20200515-000000-000_L3A_T32ULB_C_V1" \
              "-2/SENTINEL2X_20200515-000000-000_L3A_T32ULB_C_V1-2_FRC_B2.tif" # Path to a completely random sentinel tile
...
cutting_length = 2000 # The ndsm have a size of 2000x2000 pixels, too big for most neural networks. The cutter
