...
MODEL_PATH_V1 = "/home/fkt48uj/nrw/results_L1Loss_Adam_UNET_FANNED_v3/model_epoch4.pt"
MODEL_PATH_V2 = "/home/fkt48uj/nrw/results_L1Loss_Adam_UNET_FANNED_v3/model_epoch4.pt"
MODEL_PATH_V3 = "/home/fkt48uj/nrw/results_L1Loss_Adam_UNET_FANNED_v3/model_epoch4.pt"
BATCH_SIZE = 1
DEVICE = "cuda:0"
...
def setup():
    ...
    perform_tests(test_loader, [unet_v1, unet_v2, unet_v3], [True, True, True], [1, 2, 3, 4, 5, 6, 7, 8])
