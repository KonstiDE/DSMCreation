...
class model(nn.Module):
    ...
    def forward(self, x):
        x_block0, x_block1, x_block2, x_block3 = self.E(x)

        x_decoder = self.D2(x_block0, x_block1, x_block2, x_block3)

        x_mff = self.MFF(x_block0, x_block1, x_block2, x_block3, [x_decoder.size(2), x_decoder.size(3)])
